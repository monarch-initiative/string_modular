...
| [Documentation](https://monarch-initiative.github.io/string_modular) |

String v12 modular ingest
...
Download the data for the string_modular transform:

```bash
poetry run string_modular download
```

To run the Koza transform for string_modular:

```bash
poetry run string_modular transform
```

To see available options:

```bash
poetry run string_modular download --help
# or
poetry run string_modular transform --help
```
